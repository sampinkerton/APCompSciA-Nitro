...
public class CompareSearch 
{
    public static void main(String[] args)
    {
        ...
        testArrayOfLength(51);
        testArrayOfLength(13);
    }
    ...
    public static int linearSearch(int[] array, int number)
    {
        ...
        for (int i = 0; i < array.length; i++)
        {
            ...
            if (array[i] == number)
            {
                ...
                return totalCount; // the method returns as soon as the number is found
            }
        }
        return totalCount; // the code will get here if the number isn't found
    }
}
